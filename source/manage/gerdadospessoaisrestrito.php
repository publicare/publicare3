...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-info">
            ...
            <form action="do/gerdadospessoais_post/<?php echo($_page->_objeto->Valor($_page, 'cod_objeto')); ?>.html" method="POST">
                ...
                <div class="panel-body">
                    <div class="tabela row form-group">
                        <label for="InputNome" class="col-md-3 col-form-label">Nome</label>
                        <div class="col-md-9">
                    ...
                    <div class="tabela row form-group">
                        <label for="InputNome" class="col-md-3 col-form-label">Telefone</label>
                        <div class="col-md-9">
